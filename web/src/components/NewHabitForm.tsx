...
export function NewHabitForm() {
  ...
  return (
    <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
            ...
            >
              <div 
                className="h-8 w-8 rounded-lg flex items-center justify-center bg-zinc-900 border-2 border-zinc-800
                 group-data-[state=checked]:bg-green-500 group-data-[state=checked]:border-green-500 transition-colors  group-focus:ring-2 group-focus:ring-violet-600 focus:ring-offset-2 group-focus:ring-offset-background">
                <Checkbox.Indicator>
      ...
      <button
        type="submit"
        className="mt-6 rounded-lg p-4 flex items-center justify-center 
